...
class ConstraintsMetamodelPlugin : public QObject, public qReal::EditorInterface
{
	Q_OBJECT
...
public:
	...
	virtual QString id() const { return "ConstraintsMetamodel"; }
